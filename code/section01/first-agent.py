...
def get_attraction(city: str, weather: str) -> str:
    ...
    try:
        # 调用 API，include_answer=True 会返回一个综合性的问题
...
# 执行行动循环
OPEN_API_KEY = "sk-e590913424f24ab48840c207a1f54e95"
BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
MODEL_ID = "glm-5.2"
TAVILY_API_KEY = os.environ.get("TAVILY_API_KEY")

llm = OpenAICompatibleClient(model="glm-5.2", api_key=OPEN_API_KEY, base_url=BASE_URL)

user_prompt = "你好，请帮我查询一下今天成都的天气，然后根据天气推荐一个适合的旅游景点。"
...
for i in range(5):  # 设置最大循环次数
    ...
    if action_str.startswith("Finish"):
        ...
        if finish_match:
            ...
            # 兜底处理：如果格式不标准，直接提取 Finish 后面的内容
            final_answer = action_str[len("Finish"):]
